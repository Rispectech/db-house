...
function AdminAddProduct() {
    ...
    let loadData = () => {
        setPageLoading(true)
        RestAdmin.getAllCategories().then(_categories => {
            RestAdmin.getAllMerchants().then(merchants => {
                RestMerchant.getAllBrands().then(brands => {
                            ...
                            <div className=" mb-3">
                                <div className="row">
                                    <div className="col">
                                        ...
                                        <Form.Control type="text" placeholder="Enter Product Name" name="name" value={formData.name} onChange={handleNameChange} />
                                    ...
                                    <div className="col">
                                        ...
                                        <select
                                            ref={selectBrandRef} className="wide"
                                            disabled={!brands} value={formData.brandId}
                                            onChange={() => { }}>
                                ...
                                <div className="row">
                                    <div className="col">
                                        ...
                                        <div className="form-group">
                                            <select
                                                ref={selectCategoryRef} className="wide"
                                                disabled={!categories}
                                                onChange={() => { }}>
                                    ...
                                    <div className="col">
                                        ...
                                        <div className="form-group">
                                            <select
                                                ref={selectSubCategoryRef} className="wide"
                                                disabled={!subCategories} value={formData.subCategoryId}
                                                onChange={() => { }}>
                                                <option value="">Select Sub Category</option>
                                                {subCategories && (() => {
                                                    window.setTimeout(() => { $(selectSubCategoryRef.current).niceSelect('update') }, 0);
                                                    return subCategories.map(sc => (<option value={sc._id} key={sc._id}>{sc.name}</option>));
                                                })()}
                                            </select>
                                    ...
                                    <div className="col">
                                        ...
                                        <div className="form-group">
                                            <select
                                                ref={selectMerchantRef} className="wide"
                                                disabled={!merchants} value={formData.merchantId}
                                                onChange={() => { }}>
