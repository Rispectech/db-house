...
function EditSubCategory() {
    ...
    const initialFormData = {
        ...
        metaTagTitle: subCategory.metaTagTitle,
        metaTagDescription: subCategory.metaTagDescription,
        metaTagKeywords: subCategory.metaTagKeywords
    };
    ...
    const handleSubmit = async (e) => {
        ...
        if (!isError) {
            ...
            try {
                await RestAdmin.updateSubCategory({ ...data });
            ...
            try{
                if(Boolean(imageToUpload.image)) {
                    ...
                    await RestAdmin.createSubCategoryImage(formData);
                }
            } catch (e) { console.error(e) }
    ...
    useEffect(() => {
        RestAdmin.getAllCategories().then(_categories => setSubCategories(_categories));
    }, []);
                                        ...
                                        <div className="addAcordion">
                                            <form className="formStyle addFormStyle" action="#">
                                                ...
                                                <div className="row  d-flex align-items-center">
                                                    ...
                                                    <div className="col">
                                                        <Form.Control type="text" placeholder={formData.name} name="name" value={formData.name} onChange={handleChange} />
                                                            ...
                                                            <div className="form-group">
                                                                <div className="uplogInrDiv">
                                                                    ...
                                                                    <div className="uploadBlkInr">
                                                                        ...
                                                                        {(!Boolean(imageToUpload.image) && Boolean(subCategory.imageDocumentId)) && (
                                                                            <img src={`${Rest}/documents/get/${subCategory.imageDocumentId}`} alt="" height="80" />
                                                                        )}
                                                                        {(!Boolean(imageToUpload.image)) && (!Boolean(subCategory.imageDocumentId)) && (
