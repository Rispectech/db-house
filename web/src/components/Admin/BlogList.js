                                ...
                                <div className="row align-items-center justify-content-center pb-20 hdngRowBlk">
                                    ...
                                    <div className="col-auto">
                                        <div className="prdctsortCol">
                                            <div className="form-group">
                                                ...
                                                <option value="Featured">Choose</option>
                                                <option value="10">Category</option>
                                                <option value="25">Blog Title</option>    
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-auto">
                                        <div className="prdctsortCol">
                                            <div className="form-group">
                                                ...
                                                <option value="Featured">Show</option>
                                    ...
                                    <div className="col-auto">
                                        <div className="addPrdctBtn">
                                            <Link to="/admin/addblog" className="btnCommon"><span><img src={plus} alt="" height="12" /></span>Add</Link>  
                                        </div>
                                    </div>
                                </div>                              
