                ...
                <div className="materialScndItem">
                  <Link to="/category">
                    <div className="materialScndMedia">
                      <div
                        className="materialScndImg"
                        style={{ backgroundImage: `url("img/materialMarbal1.png")` }}
                      >
                ...
                <div className="materialScndItem">
                  <Link to="/category">
                    <div className="materialScndMedia">
                      <div
                        className="materialScndImg"
                        style={{ backgroundImage: `url("img/materialMarbal2.png")` }}
                      >
                        <div className="materialScndOverlay"></div>
                      </div>
                      <span className="materialScndBtn">
                ...
                <div className="materialScndItem">
                  <Link to="/category">
                    <div className="materialScndMedia">
                      <div
                        className="materialScndImg"
                        style={{ backgroundImage: `url("img/materialMarbal3.png")` }}
                      >
                        <div className="materialScndOverlay"></div>
                      </div>
                      <span className="materialScndBtn">
