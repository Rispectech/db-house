        ...
        <div className="portfolioTabsOuter">
          <div className="marblesTabsRow">
              <div className="marblesTabsOuter">
                <Tabs defaultActiveKey="all" id="uncontrolled-tab-example" className="marblesTabs">
                          ...
                          <Row className="row filterMain g-2">
                              ...
                              <div className="filtrItem">
                                <Link to="/">
                                  <div className="filtrItemMedia">
                                    <div className="filtrItemCatImg" style={{backgroundImage: `url("img/tabImg1.png")`}}>
                                      <div className="filtrOverlay"></div>
                                    </div>
                                    <span className="fitrInfoLink">
                                    <Link to="javascript:void(0)" className="">High End Projects</Link>
                                    </span>
                                  </div>
                                </Link>
                              </div>               
                            ...
                            <Col lg md={6}>
                              <div className="filtrItem">
                                <Link to="/">
                                  <div className="filtrItemMedia">
                                    <div className="filtrItemCatImg" style={{backgroundImage: `url("img/tabImg2.png")`}}>
                                      <div className="filtrOverlay"></div>
                                    </div>
                                    <span className="fitrInfoLink">
                                    <Link to="javascript:void(0)" className="">High End Projects</Link>
                            ...
                            <Col lg md={6}>
                              <div className="filtrItem">
                                <Link to="/">
                                  <div className="filtrItemMedia">
                                    <div className="filtrItemCatImg" style={{backgroundImage: `url("img/tabImg3.png")`}}>
                                      <div className="filtrOverlay"></div>
                                    </div>
                                    <span className="fitrInfoLink">
                                    <Link to="javascript:void(0)" className="">High End Projects</Link>
                          ...
                          <Row className="row filterMain g-2 pt-10">
                            <div className="col-md">
                              <div className="filtrItem">
                                <Link to="/">
                                  <div className="filtrItemMedia">
                                    <div className="filtrItemCatImg" style={{backgroundImage: `url("img/tabImg4.png")`}}>
                                      <div className="filtrOverlay"></div>
                                    </div>
                                    <span className="fitrInfoLink">
                                    <Link to="javascript:void(0)" className="">High End Projects</Link>
                            ...
                            <div className="col-md">
                              <div className="filtrItem">
                                <Link to="/">
                                  <div className="filtrItemMedia">
                                    <div className="filtrItemCatImg" style={{backgroundImage: `url("img/tabImg5.png")`}}>
                                      <div className="filtrOverlay"></div>
                                    </div>
                                    <span className="fitrInfoLink">
                                    <Link to="javascript:void(0)" className="">High End Projects</Link>
                            ...
                            <div className="col-md">
                              <div className="filtrItem">
                                <Link to="/">
                                  <div className="filtrItemMedia">
                                    <div className="filtrItemCatImg" style={{backgroundImage: `url("img/tabImg6.png")`}}>
                                      <div className="filtrOverlay"></div>
                                    </div>
                                    <span className="fitrInfoLink">
                                    <Link to="javascript:void(0)" className="">High End Projects</Link>
