                    ...
                    <path fillRule="evenodd" d="M0 10a8 8 0 1 1 15.547 2.661c-.442 1.253-1.845 1.602-2.932 1.25C11.309 13.488 9.475 13 8 13c-1.474 0-3.31.488-4.615.911-1.087.352-2.49.003-2.932-1.25A7.988 7.988 0 0 1 0 10zm8-7a7 7 0 0 0-6.603 9.329c.203.575.923.876 1.68.63C4.397 12.533 6.358 12 8 12s3.604.532 4.923.96c.757.245 1.477-.056 1.68-.631A7 7 0 0 0 8 3z"/>
                      ...
                      <Accordion.Item eventKey="2">
                        <Accordion.Header>
                          ...
                          </span>Manage Catalogue
                        </Accordion.Header>
                        <Accordion.Body>
                          <ul>
                            <li><Link to="/merchant/addproduct">Add Product</Link></li>
                            <li><Link to="/merchant/productlist2">Manage Product</Link></li>
                            <li><Link to="/merchant/manageinventory">Manage Inventory</Link></li>
                          </ul>
                        </Accordion.Body>
                      </Accordion.Item>
                        <Accordion.Item eventKey="3">
                          <Accordion.Header>
                            ...
                            <Accordion.Body>
                              <ul>
                              <li><Link to="/merchant/orderlist">Order List</Link></li>
                              </ul>
                            </Accordion.Body>
                        </Accordion.Item>
                        <Accordion.Item eventKey="4">
                          ...
                          <Accordion.Body>
                            <ul>
                              <li><Link to="/merchant/transactionlist">Payments List</Link></li>
                            </ul>                          
                          </Accordion.Body>
                        </Accordion.Item>
                      </Accordion>
