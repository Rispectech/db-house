                                ...
                                <div className="filtrAcordion drpDownAcountRow">
                                    <Accordion defaultActiveKey="0">
                                        <Accordion.Item eventKey="0">
                                            <Accordion.Header><span><img src={UserIcon}/></span> Filter Transactions</Accordion.Header>
                                            <Accordion.Body>
                                                    ...
                                                    <form className="formStyle">
                                                        <ul>
                                                            <li>
                                                                ...
                                                                <label className="form-check-label" htmlFor="1">Credit/Debit cards</label>
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div className="form-check d-flex align-items-center">
                                                                    <input type="checkbox" className="form-check-input" id="UPI"/>
                                                                    <label className="form-check-label" htmlFor="UPI">UPI</label>
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div className="form-check d-flex align-items-center">
                                                                    <input type="checkbox" className="form-check-input" id="banking"/>
                                                                    <label className="form-check-label" htmlFor="banking">Net banking</label>
                                                                </div>                                                           
                                                            </li>
                                                            <li>                                                               
                                                                <div className="form-check d-flex align-items-center">
                                            ...
                                            <div className="filtrList mb-2">
                                                <form className="formStyle">
                                                    <ul>
                                                        <li>
                                                            <div className="form-check d-flex align-items-center">
                                                            <input type="checkbox" className="form-check-input" id="Successful"/>
                                                            <label className="form-check-label" htmlFor="Successful">Successful</label>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div className="form-check d-flex align-items-center">
                                                                <input type="checkbox" className="form-check-input" id="Pending"/>
                                                                <label className="form-check-label" htmlFor="Pending">Pending</label>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div className="form-check d-flex align-items-center">
                                                                <input type="checkbox" className="form-check-input" id="Failed"/>
                                            ...
                                            <div className="filtrList mb-2">
                                                <form className="formStyle">
                                                    <ul>
                                                        <li>
                                                            <div className="form-check d-flex align-items-center">
                                                            <input type="checkbox" className="form-check-input" id="timeline1"/>
                                                            <label className="form-check-label" htmlFor="timeline1">May 2022</label>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div className="form-check d-flex align-items-center">
                                                                <input type="checkbox" className="form-check-input" id="timeline2"/>
                                                                <label className="form-check-label" htmlFor="timeline2">April 2022</label>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div className="form-check d-flex align-items-center">
                                                                <input type="checkbox" className="form-check-input" id="timeline3"/>
                                                                <label className="form-check-label" htmlFor="timeline3">March 2022</label>
                                                            </div>                                                           
                                                        </li>
                                                        <li>
                                                            <div className="form-check d-flex align-items-center">
                                                                <input type="checkbox" className="form-check-input" id="timeline4"/>
                                                                <label className="form-check-label" htmlFor="timeline4">Older Transactions</label>
                                                            </div>                                                           
                                                        </li>
                                                    </ul>
                                                </form>
                        ...
                        <div className="transctnListPage pt-4">
                                    ...
                                    <div className="row g-3 d-sm-flex align-items-center">
                                        ...
                                        <div className="col mt-0">
                                            <div className="transctnListProInfo">
                                                <div className="transctnListTitle"><h4><a href="/">Paid  on DBhouz</a></h4></div>
                                                <div className="transtnInfo">
                                                    <p>DB houz Credit Card</p>
                                                    <p><span>02 May 2022, 05:25 PM</span></p>              
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-auto d-flex align-items-center">
                                           <div className="transtnPrice red">
                                            -$25                                               
                                           </div>
                                        </div>
                                    </div>
                                ...
                                <div className="transctnListPrdct">
                                    <div className="row g-3 d-sm-flex align-items-center">
                                        ...
                                        <div className="col-auto d-flex align-items-center">
                                           <div className="transtnPrice green">
                                            -$25                                               
                                           </div>
                                        </div>
                                    </div>
