...
function AccountSetting() {
  return (
                                ...
                                <div className="filtrAcordion drpDownAcountRow">
                                    <Accordion defaultActiveKey="0">
                                        <Accordion.Item eventKey="0">
                                            <Accordion.Header><span><img src={UserIcon}/></span> Account Settings</Accordion.Header>
                                            <Accordion.Body>
                                                <div className="acoutSidebar mb-2"> 
                                                        <ul>
                                                            <li><Link to="/"><i className="fa fa-user"></i> Profile Information</Link></li>
                                        ...
                                        <Accordion.Item  eventKey="0">
                                            <Accordion.Header><span><img src={PaymentIcon}/></span> Payments</Accordion.Header>
                                            <Accordion.Body>
                                                <div className="acoutSidebar mb-2"> 
                                                    <ul>
                                                        <li>
    ...
    <path d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm-1-5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zM4 8a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zm0 2.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0z"/>
                                        ...
                                        <Accordion.Item  eventKey="0">
                                            <Accordion.Header><span><img src={StuffIcon}/></span> My Stuff</Accordion.Header>
                                            <Accordion.Body>
                                                <div className="acoutSidebar mb-2"> 
                                                    <ul>
                                                        ...
                                                        <li><Link to="/"><i className="fa fa-heart-o"></i> Wish List</Link></li>
                                                    </ul>                                                   
                                                </div>
                                            </Accordion.Body>
                                        </Accordion.Item>
                                        <Accordion.Item  eventKey="0" className="sideLogOut">
                                            <Link to="/">
                                                <span><img src={LogoutIcon}/></span> Logout
                                            </Link>
                                        </Accordion.Item>                                      
                                    </Accordion>                                
                                </div>
                                    ...
                                    <div className="row g-3 d-sm-flex align-items-center">
                                        <div className="col-auto">
                                            <div className="wishListProMedia">
                                                <a href="/product-detail">
                                                    <div className="wishListProImg" style={{backgroundImage: `url("img/CatImg3.jpg")`}}>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-auto d-flex align-items-center">
                                            ...
                                            <div className="wishLstDlet">
                                                <Link to="/"><img src="img/deleteIcon.svg"/></Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="wishListPrdct">
                                    <div className="row g-3 d-sm-flex align-items-center">
                                        <div className="col-auto">
                                            <div className="wishListProMedia">
                                                <a href="/product-detail">
                                                    <div className="wishListProImg" style={{backgroundImage: `url("img/CatImg2.jpg")`}}>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div className="wishListPrdct">
                                    <div className="row g-3 d-sm-flex align-items-center">
                                        <div className="col-auto">
                                            <div className="wishListProMedia">
                                                <a href="/product-detail">
                                                    <div className="wishListProImg" style={{backgroundImage: `url("img/CatImg4.jpg")`}}>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div className="wishListPrdct">
                                    <div className="row g-3 d-sm-flex align-items-center">
                                        <div className="col-auto">
                                            <div className="wishListProMedia">
                                                <a href="/product-detail">
                                                    <div className="wishListProImg" style={{backgroundImage: `url("img/CatImg5.jpg")`}}>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
